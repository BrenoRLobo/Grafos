...
int calculaValorTotalCaminho(GRAFO* gr, int* caminho, int numVertices) {
    ...
    for (int i = 0; i < numVertices - 1; i++) {
        int vi = caminho[i] - 1; // Convertemos o vÃ©rtice do caminho para um Ã­ndice (subtraindo 1)
        int vf = caminho[i + 1] - 1; // O mesmo para o vÃ©rtice seguinte
        ...
        if (!found) {
            // Se a aresta entre os vÃ©rtices nÃ£o for encontrada, o caminho Ã© invÃ¡lido.
            return -1;
        }
    }
